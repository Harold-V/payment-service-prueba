...
import mybill.bank.co.payment_service.application.ports.out.PaymentTransactionPayuUseCase;
...
@Slf4j
public class PayuGatewayImpl implements PaymentTransactionPayuUseCase {
